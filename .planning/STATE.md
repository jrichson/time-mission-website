...
Last activity: 2026-05-06 -- Completed quick task 260506-ksu: UX fix for P0-7a info panel discoverability — promoted "Full venue page" to primary "Visit <City>" button (verb-first per UI design brain); demoted "Book Now" to secondary outline; "Contact" stays tertiary text link. Resolves the post-RFC-#11 UAT finding where mobile users couldn't find the navigate-to-venue CTA in the inline preview. Smoke 58/58 still passing.
