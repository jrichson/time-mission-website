...
| 10. Audit-Gap Closure & Cutover Readiness | 3/7 | In Progress|  |
...
Plans:
- [x] 10-01-PLAN.md — SSR landmarks + skip-link in `SiteLayout` + decorative SVG/video `aria-hidden` sweep (P1-3, P0-4 partial, P1-12)
