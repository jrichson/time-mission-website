  ...
  await db.execute(sql`
    ...
    FROM (
      VALUES
        ...
        ('west-nyack', 0, 'west-nyack-birthdays', 'birthdays', 'https://timemission-palisades.briqbookings.com'),
        ('west-nyack', 1, 'west-nyack-corporate', 'corporate', 'https://timemission-palisades.briqbookings.com'),
        ('west-nyack', 2, 'west-nyack-field-trips', 'field-trips', 'https://timemission-palisades.briqbookings.com'),
        ('west-nyack', 3, 'west-nyack-bachelor-ette', 'bachelor-ette', 'https://timemission-palisades.briqbookings.com'),
        ('west-nyack', 4, 'west-nyack-private-events', 'private-events', 'https://timemission-palisades.briqbookings.com'),
        ('west-nyack', 5, 'west-nyack-holidays', 'holidays', 'https://timemission-palisades.briqbookings.com'),
        ('lincoln', 0, 'lincoln-birthdays', 'birthdays', 'https://bookings.clubspeed.com/R1/R1LINCOLN?filters=959'),
        ('lincoln', 1, 'lincoln-corporate', 'corporate', 'https://bookings.clubspeed.com/R1/R1LINCOLN?filters=959'),
        ('lincoln', 2, 'lincoln-field-trips', 'field-trips', 'https://bookings.clubspeed.com/R1/R1LINCOLN?filters=959'),
        ('lincoln', 3, 'lincoln-bachelor-ette', 'bachelor-ette', 'https://bookings.clubspeed.com/R1/R1LINCOLN?filters=959'),
        ('lincoln', 4, 'lincoln-private-events', 'private-events', 'https://bookings.clubspeed.com/R1/R1LINCOLN?filters=959'),
        ('lincoln', 5, 'lincoln-holidays', 'holidays', 'https://bookings.clubspeed.com/R1/R1LINCOLN?filters=959'),
        ...
        ('houston', 0, 'houston-birthdays', 'birthdays', 'https://forms.roller.app/#/timemissionhouston/bc80621a90b3417/form'),
        ('houston', 1, 'houston-corporate', 'corporate', 'https://forms.roller.app/#/timemissionhouston/bc80621a90b3417/form'),
        ('houston', 2, 'houston-field-trips', 'field-trips', 'https://forms.roller.app/#/timemissionhouston/bc80621a90b3417/form'),
        ('houston', 3, 'houston-bachelor-ette', 'bachelor-ette', 'https://forms.roller.app/#/timemissionhouston/bc80621a90b3417/form'),
        ('houston', 4, 'houston-private-events', 'private-events', 'https://forms.roller.app/#/timemissionhouston/bc80621a90b3417/form'),
        ('houston', 5, 'houston-holidays', 'holidays', 'https://forms.roller.app/#/timemissionhouston/bc80621a90b3417/form'),
        ('antwerp', 0, 'antwerp-birthdays', 'birthdays', 'https://www.experience-factory.com/antwerp/online-booking/#your-group=groups-of-friends&your-favorite-experience=time-mission'),
        ('antwerp', 1, 'antwerp-corporate', 'corporate', 'https://www.experience-factory.com/antwerp/online-booking/#your-group=groups-of-friends&your-favorite-experience=time-mission'),
        ('antwerp', 2, 'antwerp-field-trips', 'field-trips', 'https://www.experience-factory.com/antwerp/online-booking/#your-group=groups-of-friends&your-favorite-experience=time-mission'),
        ('antwerp', 3, 'antwerp-bachelor-ette', 'bachelor-ette', 'https://www.experience-factory.com/antwerp/online-booking/#your-group=groups-of-friends&your-favorite-experience=time-mission'),
        ('antwerp', 4, 'antwerp-private-events', 'private-events', 'https://www.experience-factory.com/antwerp/online-booking/#your-group=groups-of-friends&your-favorite-experience=time-mission'),
        ('antwerp', 5, 'antwerp-holidays', 'holidays', 'https://www.experience-factory.com/antwerp/online-booking/#your-group=groups-of-friends&your-favorite-experience=time-mission'),
