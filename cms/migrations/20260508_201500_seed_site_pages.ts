...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    VALUES
      ...
      ('Time Mission Boston | Coming Soon', '/boston', true, 'Time Mission Boston | Coming Soon', 'Time Mission Boston is coming soon in Boston, MA. Contact the location team for launch timing and opening updates.', 'index,follow'::"enum_site_pages_seo_robots", '/assets/photos/experiences/Time-Mission_Magma_Mayhem-2.jpg', '/assets/photos/experiences/Time-Mission_Magma_Mayhem-2.jpg'),
      ('Time Mission Edison | Coming Soon', '/edison', true, 'Time Mission Edison | Coming Soon', 'Time Mission Edison is coming soon at Supercharged Entertainment New Jersey, 987 US-1, Edison, NJ 08817.', 'noindex,follow'::"enum_site_pages_seo_robots", '/assets/photos/experiences/Time-Mission_Magma_Mayhem-2.jpg', '/assets/photos/experiences/Time-Mission_Magma_Mayhem-2.jpg'),
