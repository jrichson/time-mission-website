...
- `GET {PAYLOAD_CMS_ORIGIN}/api/blog-posts?limit=250&depth=0` for optional **published** Blog Posts. This fetch is non-fatal during rollout so the public build can publish the static blog shell before posts exist.
