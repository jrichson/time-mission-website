...
const SCOPE_FILES = {
  'root-core': [
    ...
    'src/partials/donation-main.frag.txt',
    'src/partials/press-main.frag.txt',
  ],
  'root-legal': [
    'src/pages/404.astro',
    ...
    'src/pages/press/images.astro',
    'src/pages/press/in-the-news.astro',
    'src/pages/press/brand-guidelines.astro',
    'src/partials/404-main.frag.txt',
    'src/partials/houston-spinandscore-rules-main.frag.txt',
    'src/partials/press-releases-main.frag.txt',
    'src/partials/press-images-main.frag.txt',
    'src/partials/press-in-the-news-main.frag.txt',
    'src/partials/press-brand-guidelines-main.frag.txt',
  ],
  locations: [
