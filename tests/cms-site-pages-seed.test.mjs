...
describe('CMS existing-page seed migration', () => {
  it('covers every route registry canonical path', () => {
    ...
    const migrationFiles = [
      'cms/migration-data/20260916_educators_pages_snapshot.ts',
      ...
      'cms/migrations/20260908_090000_school_night_promotions.ts',
      'cms/migration-data/20260908_school_night_promotions_snapshot.ts',
    ];
