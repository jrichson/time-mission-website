...
## Deferred: Homepage Stats Visual System
...
- When this is revisited, keep the stats content but simplify the visual system around one primary accent, quieter hover states, and fewer unused CSS variants.
